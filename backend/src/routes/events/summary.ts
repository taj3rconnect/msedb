 ...
 */
summaryRouter.post('/summarize-today', async (req: Request, res: Response) => {
 ...
 */
summaryRouter.get('/summarize-today/csv', async (req: Request, res: Response) => {
  const userId = getUserId(req);
 ...
 */
summaryRouter.post('/summarize-today/send', async (req: Request, res: Response) => {
  const userId = getUserId(req);
